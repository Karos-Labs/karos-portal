...
export const CREDIT_COSTS = {
   ...
   * limit. Charged ONCE per seat added over the limit — there is no recurring
   * seat billing anywhere in the product, so nothing here may be described as
   * a monthly rate (QA F53).
   */
  employeeSeat: 100,
} as const;
