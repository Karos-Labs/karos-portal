...
/**
 * The client's reputation agent page: the setup band and the details form - the
 * one canonical set of reputation intake surfaces, mounted with the same props
 * the run dialog renders inline. Nothing in the navigation points here; it is
 * the fallback for a caller that ships the setup flag without the inline
 * payload, and a stable deep link for the run dialog's error recovery.
 */
export default async function ReputationAgentPage({
  params,
}: {
