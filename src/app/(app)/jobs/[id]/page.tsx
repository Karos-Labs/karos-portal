...
export default async function JobDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  // Same reasoning, for a LinkedIn/X agent draft's own Publish Now button —
  // see agent-draft-auto-publish.ts.
  const agentDraftPublishPlatforms = (await agentDraftPublishPlatformsByClient(realAssets))?.[job.clientId];
