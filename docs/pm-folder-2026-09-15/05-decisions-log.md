...
| D45 | 2026-09-22 | The three TikTok agents are named as roles on a team: **TikTok Clipper** (was TikTok clipping), **TikTok Editor** (was TikTok editing, formerly Branded shorts) and **TikTok Producer** (was TikTok content design). Keys, products and bands are unchanged (D08, D20). On karoslabs.com they are one **TikTok Agent** whose page toggles between Clipper, Editor and Producer | catalog, landing page |
