...
const V2_DATA = {
  ...
  name: "X Agent",
  description:
    "On-demand X drafting engine: any identity (company page or one seat) can run at any time for a batch of 5, 10, or 21 drafts. Resumable, and the paid research pull is shared across the whole batch instead of per-format.",
  clientBlurb:
    "Drafts a batch of X posts on demand, any time, spanning your build-in-public, knowledge, POV, news-reaction and quote lanes.",
  icon: "Zap",
  color: "#FDE047",
